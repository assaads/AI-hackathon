...
import type { i18nSchemaOutput } from '@astrojs/starlight/schemas/i18n';
import { createTranslationSystem } from '@astrojs/starlight/utils/createTranslationSystem';
import type { StarlightConfig } from '@astrojs/starlight/utils/user-config';
