...
import { ComponentConfigSchema } from '@astrojs/starlight/schemas/components';
import { ExpressiveCodeSchema } from '@astrojs/starlight/schemas/expressiveCode';
import { FaviconSchema } from '@astrojs/starlight/schemas/favicon';
import { HeadConfigSchema } from '@astrojs/starlight/schemas/head';
import { LogoConfigSchema } from '@astrojs/starlight/schemas/logo';
import { SidebarItemSchema } from '@astrojs/starlight/schemas/sidebar';
import { SocialLinksSchema } from '@astrojs/starlight/schemas/social';
import { TableOfContentsSchema } from '@astrojs/starlight/schemas/tableOfContents';
